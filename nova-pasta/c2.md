...
<img src="imagens/esboço-principal.png" alt="Esboço Principal">
...
<img src="imagens/esboço-plataformas.png" alt="Esboço Plataformas">

**Descrição:** Esboço da página das plataformas de streaming mostrando a organização dos conteúdos em cartões informativos e imagens representativas.
...
**Descrição:** Wireframe da estrutura principal do website, incluindo cabeçalho, menu de navegação e secções de conteúdo. O layout foi desenvolvido para ser responsivo e adaptar-se a dispositivos móveis, tablets e computadores.
