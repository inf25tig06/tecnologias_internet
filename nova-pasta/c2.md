...
**Descrição:** Wireframe da estrutura principal do website, incluindo cabeçalho, menu de navegação e secções de conteúd. O layout foi desenvolvido para ser responsivo e adaptar-se a dispositivos móveis, tablets e computadores.
