...
### Mapa do Website
<h2>Esboço da Página Inicial</h2>
<img src="imagens/esboco-inicial.png" alt="Esboço da página inicial">
<p>Esboço da página inicial apresentando o menu de navegação e a introdução ao tema.</p>
**Descrição:** Diagrama representando a organização das páginas e a navegação principal entre as diferentes secções do website.
